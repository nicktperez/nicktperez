...
IT systems professional with 10+ years of experience across endpoint management, identity, infrastructure, automation, and technical support. I build practical security monitoring and endpoint visibility tools with an emphasis on explainable detections, privacy, and reproducible workflows.
...
- [QuestBond](https://github.com/nicktperez/RollTogether) — Native SwiftUI app for matching D&D players and groups using filters, fit scoring, chat, and Supabase.
...
The best way to learn more about my work or contact me is through [nicholastperez.com](https://nicholastperez.com).
